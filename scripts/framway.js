...
var combineConfigs = function(){
  ...
  // 
  // EMAIL UPDATER
 var strEmails   = "/* /!\\ WARNING: Do not edit this file. It will be rewritten in the compilation process. */\n"
			   				 + "/* Default configuration & mixins */\n"
             	   + "@import '../core/scss/mixins';\n"
             	   + "@import '../core/scss/vars';\n"
	...
	strEmails   += "/* Core styles */\n"
	        		+ "@import 'core';\n";
	// strEmails   += "/* Components styles */\n";
	// for (var i = 0; i < configCleaned.components.length; i++) {
	//   strEmails   += "@import '../components/"+configCleaned.components[i]+"/"+configCleaned.components[i]+"';\n";
	// }
	// strEmails   += "/* Themes styles override */\n";
	// for (var i = 0; i < configCleaned.themes.length; i++) {
	//   strEmails   += "@import '../themes/"+configCleaned.themes[i]+"/"+configCleaned.themes[i]+"';\n";
	// }
  if(strEmails   != fs.readFileSync('./src/emails/emails.scss', 'utf8')){
		fs.outputFileSync('./src/emails/emails.scss',strEmails)  ;
	  console.log('\n### emails rewritten \n');
	}
  // EMAIL UPDATER END
  // 
